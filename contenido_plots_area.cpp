...
void contenido_plots_area::on_SBk_valueChanged(double arg1)
{

}

void contenido_plots_area::on_SBmin_valueChanged(double arg1)
{

}

void contenido_plots_area::on_SBmax_valueChanged(double arg1)
{

}

void contenido_plots_area::on_SBinc_valueChanged(double arg1)
{

}

void contenido_plots_area::on_Services_cellChanged(int row, int column)
{
